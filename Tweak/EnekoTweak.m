...
#pragma mark - Eneko Preferences

static void load_eneko_preferences() {
    enekoPreferences = [[NSUserDefaults alloc] initWithSuiteName:kPreferencesIdentifier];

    [enekoPreferences registerDefaults:@{
    ...
    pfEnekoEnabled = [[enekoPreferences objectForKey:kPreferenceKeyEnabled] boolValue];
    pfEnableLockScreenWallpaper = [[enekoPreferences objectForKey:kPreferenceKeyEnableLockScreenWallpaper] boolValue];
    pfLockScreenVolume = [[enekoPreferences objectForKey:kPreferenceKeyLockScreenVolume] floatValue];
    pfEnableHomeScreenWallpaper = [[enekoPreferences objectForKey:kPreferenceKeyEnableHomeScreenWallpaper] boolValue];
    pfHomeScreenVolume = [[enekoPreferences objectForKey:kPreferenceKeyHomeScreenVolume] floatValue];
    pfZoomWallpaper = [[enekoPreferences objectForKey:kPreferenceKeyZoomWallpaper] boolValue];
    pfMuteWhenMusicPlays = [[enekoPreferences objectForKey:kPreferenceKeyMuteWhenMusicPlays] boolValue];
    pfDisableInLowPowerMode = [[enekoPreferences objectForKey:kPreferenceKeyDisableInLowPowerMode] boolValue];
}

__attribute((constructor)) static void initialize_eneko() {
    load_eneko_preferences();
    ...
    CFNotificationCenterAddObserver(CFNotificationCenterGetDarwinNotifyCenter(), NULL, (CFNotificationCallback)load_eneko_preferences, (CFStringRef)@"com.axs.combinedtweakprefs.reload", NULL, (CFNotificationSuspensionBehavior)kNilOptions);
}
